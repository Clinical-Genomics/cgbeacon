...
Other information such as the beacon id, name, description etc. can be customized by modifying parameters in this file.<br><br>
...
Once the beacon is started it operates at the default address: **http://localhost:9075/elixirbeacon/v03/**<br>
