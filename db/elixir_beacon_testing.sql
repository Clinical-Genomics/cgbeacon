...
--
-- Host: localhost    Database: elixir_beacon_testing
-- ------------------------------------------------------
...
--
-- Current Database: `elixir_beacon_testing`
--

/*!40000 DROP DATABASE IF EXISTS `elixir_beacon_testing`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `elixir_beacon_testing` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `elixir_beacon_testing`;
...
/*!50001 CREATE VIEW `beacon_data` AS SELECT 
 1 AS `dataset_id`,
 1 AS `chromosome`,
 1 AS `position`,
 1 AS `alternate`,
 1 AS `reference_genome`*/;
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `beacon_dataset` AS SELECT 
 1 AS `id`,
 1 AS `description`,
 1 AS `access_type`,
 1 AS `reference_genome`,
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `beacon_dataset_adam` AS SELECT 
 1 AS `dataset_id`,
 1 AS `attribute`,
 1 AS `value`*/;
SET character_set_client = @saved_cs_client;
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `beacon_dataset_consent_code` AS SELECT 
 1 AS `dataset_id`,
 1 AS `code`,
 1 AS `description`,
 1 AS `detail`,
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `beacon_dataset_adam` AS select `subq`.`dataset_id` AS `dataset_id`,`a`.`attribute` AS `attribute`,`subq`.`value` AS `value` from (((select `da`.`dataset_id` AS `dataset_id`,`da`.`adam_id` AS `adam_id`,`av`.`value` AS `value` from (`elixir_beacon_testing`.`beacon_dataset_adam_table` `da` join `elixir_beacon_testing`.`adam_value_table` `av` on((`av`.`id` = `da`.`value_id`)))) union select `detailed`.`dataset_id` AS `dataset_id`,`detailed`.`adam_id` AS `adam_id`,`detailed`.`value` AS `value` from `elixir_beacon_testing`.`beacon_dataset_adam_detailed_table` `detailed` order by `dataset_id`,`adam_id`) `subq` join `elixir_beacon_testing`.`adam_table` `a` on((`a`.`id` = `subq`.`adam_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-10-14  7:50:12
